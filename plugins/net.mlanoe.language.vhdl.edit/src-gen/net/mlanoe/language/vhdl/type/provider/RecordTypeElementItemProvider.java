...
/**
 * This is the item provider adapter for a {@link net.mlanoe.language.vhdl.type.RecordTypeElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RecordTypeElementItemProvider extends VhdlObjectItemProvider {
	/**
	 ...
	 * @generated
	 */
	public RecordTypeElementItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns RecordTypeElement.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/RecordTypeElement"));
	}
	...
	public String getText(Object object) {
		String label = ((RecordTypeElement)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_RecordTypeElement_type") :
			getString("_UI_RecordTypeElement_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(RecordTypeElement.class)) {
