...
/**
 * This is the item provider adapter for a {@link net.mlanoe.language.vhdl.declaration.AliasDeclaration} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AliasDeclarationItemProvider extends DeclarationItemProvider {
	/**
	 ...
	 * @generated
	 */
	public AliasDeclarationItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DeclarationPackage.Literals.ALIAS_DECLARATION__ALIAS);
			childrenFeatures.add(DeclarationPackage.Literals.ALIAS_DECLARATION__IS);
		}
	...
	/**
	 * This returns AliasDeclaration.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/AliasDeclaration"));
	}
	...
	public String getText(Object object) {
		String label = ((AliasDeclaration)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_AliasDeclaration_type") :
			getString("_UI_AliasDeclaration_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(AliasDeclaration.class)) {
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			...
			childFeature == DeclarationPackage.Literals.ALIAS_DECLARATION__ALIAS ||
			childFeature == DeclarationPackage.Literals.ALIAS_DECLARATION__IS;
