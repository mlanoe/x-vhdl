...
/**
 * This is the item provider adapter for a {@link net.mlanoe.language.vhdl.declaration.SubprogramDeclaration} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SubprogramDeclarationItemProvider extends DeclarationItemProvider {
	/**
	 ...
	 * @generated
	 */
	public SubprogramDeclarationItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DeclarationPackage.Literals.SUBPROGRAM_DECLARATION__PARAMETER);
			childrenFeatures.add(DeclarationPackage.Literals.SUBPROGRAM_DECLARATION__BODY);
		}
	...
	/**
	 * This returns SubprogramDeclaration.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SubprogramDeclaration"));
	}
	...
	public String getText(Object object) {
		String label = ((SubprogramDeclaration)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_SubprogramDeclaration_type") :
			getString("_UI_SubprogramDeclaration_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SubprogramDeclaration.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DeclarationPackage.Literals.SUBPROGRAM_DECLARATION__BODY,
				 DeclarationFactory.eINSTANCE.createSubprogramBody()));
	}
