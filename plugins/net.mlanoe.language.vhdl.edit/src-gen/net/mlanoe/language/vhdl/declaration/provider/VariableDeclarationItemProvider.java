...
/**
 * This is the item provider adapter for a {@link net.mlanoe.language.vhdl.declaration.VariableDeclaration} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VariableDeclarationItemProvider extends ValueDeclarationItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_VariableDeclaration_shared_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_VariableDeclaration_shared_feature", "_UI_VariableDeclaration_type"),
				 DeclarationPackage.Literals.VARIABLE_DECLARATION__SHARED,
				 true,
				 false,
				 false,
	...
	protected void addModePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_VariableDeclaration_mode_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_VariableDeclaration_mode_feature", "_UI_VariableDeclaration_type"),
				 DeclarationPackage.Literals.VARIABLE_DECLARATION__MODE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((VariableDeclaration)object).getId();
