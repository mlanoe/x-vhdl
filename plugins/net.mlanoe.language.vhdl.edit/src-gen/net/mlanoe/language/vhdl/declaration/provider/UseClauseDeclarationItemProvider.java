...
/**
 * This is the item provider adapter for a {@link net.mlanoe.language.vhdl.declaration.UseClauseDeclaration} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UseClauseDeclarationItemProvider extends DeclarationItemProvider {
	/**
	 ...
	 * @generated
	 */
	public UseClauseDeclarationItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DeclarationPackage.Literals.USE_CLAUSE_DECLARATION__USE);
		}
	...
	/**
	 * This returns UseClauseDeclaration.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/UseClauseDeclaration"));
	}
	...
	public String getText(Object object) {
		String label = ((UseClauseDeclaration)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_UseClauseDeclaration_type") :
			getString("_UI_UseClauseDeclaration_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(UseClauseDeclaration.class)) {
