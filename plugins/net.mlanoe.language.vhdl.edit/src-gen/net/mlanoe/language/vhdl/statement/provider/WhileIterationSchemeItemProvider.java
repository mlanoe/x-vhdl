...
/**
 * This is the item provider adapter for a {@link net.mlanoe.language.vhdl.statement.WhileIterationScheme} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class WhileIterationSchemeItemProvider extends IterationSchemeItemProvider {
	/**
	 ...
	 * @generated
	 */
	public WhileIterationSchemeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(StatementPackage.Literals.WHILE_ITERATION_SCHEME__CONDITION);
		}
	...
	/**
	 * This returns WhileIterationScheme.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/WhileIterationScheme"));
	}
	...
	public String getText(Object object) {
		String label = ((WhileIterationScheme)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_WhileIterationScheme_type") :
			getString("_UI_WhileIterationScheme_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(WhileIterationScheme.class)) {
