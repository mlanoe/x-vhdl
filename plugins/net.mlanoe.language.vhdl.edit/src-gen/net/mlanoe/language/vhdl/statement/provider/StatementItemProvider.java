...
/**
 * This is the item provider adapter for a {@link net.mlanoe.language.vhdl.statement.Statement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StatementItemProvider extends VhdlObjectItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Statement_label_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Statement_label_feature", "_UI_Statement_type"),
				 StatementPackage.Literals.STATEMENT__LABEL,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Statement.class)) {
			case StatementPackage.STATEMENT__LABEL:
