...
/**
 * This is the item provider adapter for a {@link net.mlanoe.language.vhdl.statement.SimultaneousProceduralStatement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SimultaneousProceduralStatementItemProvider extends StatementItemProvider {
	/**
	 ...
	 * @generated
	 */
	public SimultaneousProceduralStatementItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(StatementPackage.Literals.SIMULTANEOUS_PROCEDURAL_STATEMENT__DECLARATION);
			childrenFeatures.add(StatementPackage.Literals.SIMULTANEOUS_PROCEDURAL_STATEMENT__STATEMENT);
		}
	...
	/**
	 * This returns SimultaneousProceduralStatement.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SimultaneousProceduralStatement"));
	}
	...
	public String getText(Object object) {
		String label = ((SimultaneousProceduralStatement)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_SimultaneousProceduralStatement_type") :
			getString("_UI_SimultaneousProceduralStatement_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SimultaneousProceduralStatement.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(StatementPackage.Literals.SIMULTANEOUS_PROCEDURAL_STATEMENT__DECLARATION,
		...
		newChildDescriptors.add
			(createChildParameter
				(StatementPackage.Literals.SIMULTANEOUS_PROCEDURAL_STATEMENT__STATEMENT,
