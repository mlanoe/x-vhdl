...
/**
 * This is the item provider adapter for a {@link net.mlanoe.language.vhdl.statement.SelectedSignalAssignmentStatement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SelectedSignalAssignmentStatementItemProvider extends ConditionalSignalAssignmentStatementItemProvider {
	/**
	 ...
	 * @generated
	 */
	public SelectedSignalAssignmentStatementItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(StatementPackage.Literals.SELECTED_SIGNAL_ASSIGNMENT_STATEMENT__SELECTED);
		}
	...
	/**
	 * This returns SelectedSignalAssignmentStatement.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SelectedSignalAssignmentStatement"));
	}
	...
	public String getText(Object object) {
		String label = ((SelectedSignalAssignmentStatement)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_SelectedSignalAssignmentStatement_type") :
			getString("_UI_SelectedSignalAssignmentStatement_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SelectedSignalAssignmentStatement.class)) {
