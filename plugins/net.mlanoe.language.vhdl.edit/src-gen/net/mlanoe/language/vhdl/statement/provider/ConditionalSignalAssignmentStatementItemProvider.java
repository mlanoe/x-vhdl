...
/**
 * This is the item provider adapter for a {@link net.mlanoe.language.vhdl.statement.ConditionalSignalAssignmentStatement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConditionalSignalAssignmentStatementItemProvider extends SignalAssignmentStatementItemProvider {
	/**
	 ...
	 * @generated
	 */
	public ConditionalSignalAssignmentStatementItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(StatementPackage.Literals.CONDITIONAL_SIGNAL_ASSIGNMENT_STATEMENT__WAVEFORM);
		}
	...
	/**
	 * This returns ConditionalSignalAssignmentStatement.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ConditionalSignalAssignmentStatement"));
	}
	...
	public String getText(Object object) {
		String label = ((ConditionalSignalAssignmentStatement)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_ConditionalSignalAssignmentStatement_type") :
			getString("_UI_ConditionalSignalAssignmentStatement_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ConditionalSignalAssignmentStatement.class)) {
