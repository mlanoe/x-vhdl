...
/**
 * This is the item provider adapter for a {@link net.mlanoe.language.vhdl.statement.ForGenerationScheme} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ForGenerationSchemeItemProvider extends GenerationSchemeItemProvider {
	/**
	 ...
	 * @generated
	 */
	public ForGenerationSchemeItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ForGenerationScheme_variable_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ForGenerationScheme_variable_feature", "_UI_ForGenerationScheme_type"),
				 StatementPackage.Literals.FOR_GENERATION_SCHEME__VARIABLE,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(StatementPackage.Literals.FOR_GENERATION_SCHEME__IN);
		}
	...
	/**
	 * This returns ForGenerationScheme.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ForGenerationScheme"));
	}
	...
	public String getText(Object object) {
		String label = ((ForGenerationScheme)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_ForGenerationScheme_type") :
			getString("_UI_ForGenerationScheme_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ForGenerationScheme.class)) {
