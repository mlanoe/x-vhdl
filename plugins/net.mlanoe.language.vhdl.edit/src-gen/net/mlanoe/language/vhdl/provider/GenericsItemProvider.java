...
/**
 * This is the item provider adapter for a {@link net.mlanoe.language.vhdl.Generics} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GenericsItemProvider extends VhdlObjectItemProvider {
	/**
	 ...
	 * @generated
	 */
	public GenericsItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(VhdlPackage.Literals.GENERICS__DECLARATION);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Generics"));
	}
	...
	public String getText(Object object) {
		String label = ((Generics)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_Generics_type") :
			getString("_UI_Generics_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Generics.class)) {
			case VhdlPackage.GENERICS__DECLARATION:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(VhdlPackage.Literals.GENERICS__DECLARATION,
