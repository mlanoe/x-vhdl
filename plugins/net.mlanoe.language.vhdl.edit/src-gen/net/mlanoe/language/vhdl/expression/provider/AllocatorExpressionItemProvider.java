...
/**
 * This is the item provider adapter for a {@link net.mlanoe.language.vhdl.expression.AllocatorExpression} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AllocatorExpressionItemProvider extends ExpressionItemProvider {
	/**
	 ...
	 * @generated
	 */
	public AllocatorExpressionItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns AllocatorExpression.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/AllocatorExpression"));
	}
	...
	public String getText(Object object) {
		String label = ((AllocatorExpression)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_AllocatorExpression_type") :
			getString("_UI_AllocatorExpression_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(AllocatorExpression.class)) {
