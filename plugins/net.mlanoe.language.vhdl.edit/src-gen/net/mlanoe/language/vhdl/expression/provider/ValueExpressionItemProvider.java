...
/**
 * This is the item provider adapter for a {@link net.mlanoe.language.vhdl.expression.ValueExpression} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ValueExpressionItemProvider extends ExpressionItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ValueExpression_value_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ValueExpression_value_feature", "_UI_ValueExpression_type"),
				 ExpressionPackage.Literals.VALUE_EXPRESSION__VALUE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((ValueExpression)object).getId();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ValueExpression.class)) {
			case ExpressionPackage.VALUE_EXPRESSION__VALUE:
