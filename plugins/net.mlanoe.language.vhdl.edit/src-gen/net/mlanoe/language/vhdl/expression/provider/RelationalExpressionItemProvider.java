...
/**
 * This is the item provider adapter for a {@link net.mlanoe.language.vhdl.expression.RelationalExpression} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RelationalExpressionItemProvider extends BinaryExpressionItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ExpressionPackage.Literals.RELATIONAL_EXPRESSION__OPERATOR,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((RelationalExpression)object).getId();
