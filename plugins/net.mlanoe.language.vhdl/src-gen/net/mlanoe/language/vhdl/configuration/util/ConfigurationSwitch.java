...
public class ConfigurationSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ConfigurationPackage.BLOCK_CONFIGURATION: {
				...
				if (result == null) result = caseNamed(blockConfiguration);
				if (result == null) result = caseVhdlObject(blockConfiguration);
			...
			case ConfigurationPackage.COMPONENT_CONFIGURATION: {
				...
				if (result == null) result = caseVhdlObject(componentConfiguration);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ConfigurationPackage.CONFIGURATION: {
				...
				if (result == null) result = caseNamed(configuration);
				if (result == null) result = caseVhdlObject(configuration);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ConfigurationPackage.CONFIGURATION_ITEM: {
				ConfigurationItem configurationItem = (ConfigurationItem)theEObject;
				T result = caseConfigurationItem(configurationItem);
				if (result == null) result = caseVhdlObject(configurationItem);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ConfigurationPackage.CONFIGURATION_REFERENCE: {
			...
			case ConfigurationPackage.CONFIGURATION_RESOLVED_REFERENCE: {
				ConfigurationResolvedReference configurationResolvedReference = (ConfigurationResolvedReference)theEObject;
				T result = caseConfigurationResolvedReference(configurationResolvedReference);
				if (result == null) result = caseVhdlObject(configurationResolvedReference);
				if (result == null) result = caseConfigurationReference(configurationResolvedReference);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Resolved Reference</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Resolved Reference</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseConfigurationResolvedReference(ConfigurationResolvedReference object) {
		return null;
	}
