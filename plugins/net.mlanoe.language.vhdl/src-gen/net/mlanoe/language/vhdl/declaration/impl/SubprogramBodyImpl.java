 ...
 * <ul>
 *   <li>{@link net.mlanoe.language.vhdl.declaration.impl.SubprogramBodyImpl#getDeclaration <em>Declaration</em>}</li>
 *   <li>{@link net.mlanoe.language.vhdl.declaration.impl.SubprogramBodyImpl#getStatement <em>Statement</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class SubprogramBodyImpl extends VhdlObjectImpl implements SubprogramBody {
	/**
	...
	protected EClass eStaticClass() {
		return DeclarationPackage.Literals.SUBPROGRAM_BODY;
	}
	...
	public EList<Declaration> getDeclaration() {
		if (declaration == null) {
			declaration = new EObjectContainmentEList<Declaration>(Declaration.class, this, DeclarationPackage.SUBPROGRAM_BODY__DECLARATION);
		}
		return declaration;
	}
	...
	public EList<Statement> getStatement() {
		if (statement == null) {
			statement = new EObjectContainmentEList<Statement>(Statement.class, this, DeclarationPackage.SUBPROGRAM_BODY__STATEMENT);
		}
		return statement;
	}
