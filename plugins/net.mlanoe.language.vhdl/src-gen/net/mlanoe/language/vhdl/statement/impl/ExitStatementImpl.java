 ...
 * <ul>
 *   <li>{@link net.mlanoe.language.vhdl.statement.impl.ExitStatementImpl#getExit <em>Exit</em>}</li>
 *   <li>{@link net.mlanoe.language.vhdl.statement.impl.ExitStatementImpl#getWhen <em>When</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ExitStatementImpl extends StatementImpl implements ExitStatement {
	...
	protected EClass eStaticClass() {
		return StatementPackage.Literals.EXIT_STATEMENT;
	}
	...
	public void setExit(String newExit) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StatementPackage.EXIT_STATEMENT__EXIT, oldExit, exit));
	}
	...
	public NotificationChain basicSetWhen(Expression newWhen, NotificationChain msgs) {
		...
		when = newWhen;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, StatementPackage.EXIT_STATEMENT__WHEN, oldWhen, newWhen);
	...
	public void setWhen(Expression newWhen) {
		if (newWhen != when) {
			...
			if (when != null)
				msgs = ((InternalEObject)when).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - StatementPackage.EXIT_STATEMENT__WHEN, null, msgs);
			if (newWhen != null)
				msgs = ((InternalEObject)newWhen).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - StatementPackage.EXIT_STATEMENT__WHEN, null, msgs);
			msgs = basicSetWhen(newWhen, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StatementPackage.EXIT_STATEMENT__WHEN, newWhen, newWhen));
	}
