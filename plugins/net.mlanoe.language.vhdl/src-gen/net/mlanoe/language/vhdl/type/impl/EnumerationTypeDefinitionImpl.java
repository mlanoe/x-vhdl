 ...
 * <ul>
 *   <li>{@link net.mlanoe.language.vhdl.type.impl.EnumerationTypeDefinitionImpl#getLiteral <em>Literal</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EnumerationTypeDefinitionImpl extends TypeDefinitionImpl implements EnumerationTypeDefinition {
	...
	protected EClass eStaticClass() {
		return TypePackage.Literals.ENUMERATION_TYPE_DEFINITION;
	}
	...
	public EList<EnumerationLiteral> getLiteral() {
		if (literal == null) {
			literal = new EObjectContainmentEList<EnumerationLiteral>(EnumerationLiteral.class, this, TypePackage.ENUMERATION_TYPE_DEFINITION__LITERAL);
		}
		return literal;
	}
