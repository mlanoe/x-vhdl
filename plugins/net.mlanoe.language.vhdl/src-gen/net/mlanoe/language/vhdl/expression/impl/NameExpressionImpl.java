 ...
 * <ul>
 *   <li>{@link net.mlanoe.language.vhdl.expression.impl.NameExpressionImpl#getElement <em>Element</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class NameExpressionImpl extends ExpressionImpl implements NameExpression {
	...
	protected EClass eStaticClass() {
		return ExpressionPackage.Literals.NAME_EXPRESSION;
	}
	 ...
	 * @generated
	 */
	public EList<Name> getElement() {
		if (element == null) {
			element = new EObjectContainmentEList<Name>(Name.class, this, ExpressionPackage.NAME_EXPRESSION__ELEMENT);
		}
		return element;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case ExpressionPackage.NAME_EXPRESSION__ELEMENT:
				getElement().clear();
				getElement().addAll((Collection<? extends Name>)newValue);
				return;
		}
